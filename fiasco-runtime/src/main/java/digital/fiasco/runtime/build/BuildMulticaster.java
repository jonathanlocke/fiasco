 ...
 * @author jonathan
 */
public class BuildMulticaster implements BuildListener
{
    /** The listeners to call when this listener is called */
    private final ObjectList<BuildListener> buildListeners;

    public BuildMulticaster(ObjectList<BuildListener> buildListeners)
    {
